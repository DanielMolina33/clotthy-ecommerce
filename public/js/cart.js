...
var token = js_cookie__WEBPACK_IMPORTED_MODULE_0__["default"].get('token');
var BASE_URL = "https://api.clotthy.com/api";
var cartId = localStorage.getItem("cartId");
var btn = document.querySelectorAll('.btn');
var btnAmount = document.querySelectorAll('.quantity-field');
var productId = document.querySelector('#productId');
btn.forEach(function (item) {
  item.addEventListener('click', deleteItem);
});
btnAmount.forEach(function (item) {
...
function _addItem() {
  _addItem = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
    var data, config;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            config = setData('PUT', data, token);
            _context.prev = 7;
            disableBtn(btnAmount, true, 'not-allowed');
            _context.next = 11;
            return fetch("".concat(BASE_URL, "/cart/").concat(cartId), config).then(function (res) {
              if (res.status == '400') {
                return new Promise.resolve({
                  'error': 'Hubo un error al actualizar el producto, intentalo de nuevo'
                });
              }
...
function _deleteItem() {
  _deleteItem = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    var data, config;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 5:
            ...
            config = setData('PATCH', data, token);
            _context2.prev = 7;
...
function disableBtn(btn, disable, cursor) {
