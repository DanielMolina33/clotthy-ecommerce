...
(() => {
/*!****************************************!*\
  !*** ./resources/js/passwordForgot.js ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return fetch("".concat(BASE_URL, "/password/forgot/customers"), fetchConfig).then(function (res) {
              return res.json();
            }).then(function (res) {
              if (res.message) {
                alert(res.message);
                ...
                if (res.message == 'Correo electronico enviado correctamente') {
                  window.location.href = "".concat(_config__WEBPACK_IMPORTED_MODULE_0__.config.PageUrl, "/login");
                }
              } else {
